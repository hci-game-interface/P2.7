'use strict';
       ...
       var timecount =0;
        ...
        var clickX = 220;
        var clickY = 400;
        var previewCenterX = 450;
        var previewCenterY = 250;
        var mainFont = 'bold 48px oswald semibold';
        var smallFont = 'bold 18px oswald semibold';
        var colors = ['green', 'red', 'blue', 'purple', 'orange', 'blueviolet', 'magenta'];
        var gridRect = { x: 130, y: 45, w: 300, h: 520 };
        var previewRect = { x: 500, y: 180, w: 100, h: 200 };
        var titleRect = { x: 160, y: 95, w: 252, h: 100 };
        var clickRect = { x: 160, y: 375, w: 252, h: 40 };
        var outerRect = { x: 15, y: 5, w: 630, h: 630 };
        var squareBorder = 'white';
        var titlebgColor = '#800080';
        var textColor = 'yellow';
        var bgColor = '#5314e7';
        var gridColor = '#2a3439';
        var gridBorderColor = '#d4af37';
        var largeStroke = 5;
        var smallStroke = 2;
 ...
 console.log(pause)
          ...
          function drawPauseScreen()
          {
            ...
            g.font = smallFont;
            g.fillText('Game has been Paused', clickX, clickY); 
          }
       ...
       function animate(lastFrameTime) {
          ...
          var  time = new Date().getTime();
            ...
            if (lastFrameTime + delay < time) {
                ...
                if (!scoreboard.isGameOver()&&pause==false) {
                     timecount++;
